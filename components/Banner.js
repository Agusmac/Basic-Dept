...
export default function Banner() {
    return (
        <div className='w-full px-[27px] md:px-11 xl:px-[76.8px] mb-[30px] md:mb-[60px] xl:mb-[120px]'>
            <hr className='w-full border-[#252422] mb-[60px] md:mb-[81.6px]' />
            <div className='w-full flex flex-col xl:flex-row '>
                <div className='flex-1 2xl:pr-32  '>
                    ...
                    <div className='relative overflow-hidden group grid place-content-center mt-10 border cursor-pointer rounded-2xl border-[#252422] py-[6px] px-[29px] text-[11px] tracking-[-0.22px] w-fit uppercase font-bold'>
