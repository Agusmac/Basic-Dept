...
export default function Featured() {
    ...
    return (
        <>
            <div className='w-full px-[27px] md:px-11 xl:px-[76.8px] '>
                <hr className='w-full border-[#252422] mb-5' />
            ...
            {/* Carousel */}
            <div className='w-full flex gap-5 overflow-x-scroll scrollbar-hide scrollable-container-2 mb-[30px] md:mb-[60px] xl:mb-[120px] px-[27px] md:px-11 xl:px-[76.8px]'>
               
                <div className='flex-1 featured-item cursor-pointer list-itemer'>
                    <div className='overflow-hidden relative'>
                        <Image className='max-h-[38.5px] w-auto' src='/Assets/Google-logo.webp' alt='BD-logo' quality={100} width={720} height={244} />
                        <hr className='w-5 border-[#252422] border-[1px] mt-5 mb-[50px] md:mb-24' />
                    </div>
                ...
                <div className='flex-1 featured-item cursor-pointer list-itemer'>
                    <div className='overflow-hidden relative'>
                        <Image className='w-auto  max-h-[38.5px]' src='/Assets/Kfc-logo.webp' alt='BD-logo' quality={100} width={720} height={244} />
                        <hr className='w-5 border-[#252422] border-[1px] mt-5 mb-[50px] md:mb-24' />
                ...
                <div className='flex-1 featured-item cursor-pointer list-itemer'>
                    <div className='overflow-hidden relative'>
                        <Image className='w-auto max-h-[38.5px]' src='/Assets/Wilson-logo.webp' alt='BD-logo' quality={100} width={720} height={244} />
                        <hr className='w-5 border-[#252422] border-[1px] mt-5 mb-[50px] md:mb-24' />
                ...
                <div className='flex-1 featured-item cursor-pointer list-itemer'>
                    <div className='overflow-hidden relative'>
                        <Image className='w-auto max-h-[38.5px]' src='/Assets/AtAt-logo.webp' alt='BD-logo' quality={100} width={720} height={244} />
                        <hr className='w-5 border-[#252422] border-[1px] mt-5 mb-[50px] md:mb-24' />
                ...
                <div className='flex-1 featured-item cursor-pointer list-itemer'>
                    <div className='overflow-hidden relative'>
                        <Image className='w-auto max-h-[38.5px]' src='/Assets/Patagonia-logo.webp' alt='BD-logo' quality={100} width={720} height={244} />
                        <hr className='w-5 border-[#252422] border-[1px] mt-5 mb-[50px] md:mb-24' />
